...
function M.init(client, bufnr)
  ...
  buf_map(bufnr, 'n', 'ge', '<cmd>Lspsaga show_line_diagnostics<cr>')
  ...
  -- formatting
  buf_map(bufnr, 'n', '<leader>fm', '<cmd>lua vim.lsp.buf.formatting()<cr>')
  buf_map(bufnr, 'v', '<leader>fm', '<cmd>lua vim.lsp.buf.range_formatting()<cr>')
